...
from sdp.model.common.normalizer import LinearNormalizer
from sdp.model.equivariant_diffusion.non_equ_irrep_conditional_unet1d import NonEquIrrepConditionalUnet1D
from sdp.model.equivariant_diffusion.reg_rep_conditional_unet1d import RegRepConditionalUnet1D
from sdp.model.vision.pc_rot_randomizer import PointCloudRotRandomizer
from sdp.model.diffusion.mask_generator import LowdimMaskGenerator
from sdp.common.pytorch_util import dict_apply
from sdp.model.equivariant_vision.equiformer_enc import EquiFormerEnc
from sdp.model.equivariant_diffusion.irreps_conditional_unet1d import IrrepConditionalUnet1D
from sdp.model.vision.pc_so3_randomizer import PointCloudSO3RotRandomizer
...
class STEP(BasePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # from sdp.common.animate_pcd import animate_point_clouds
