...
from sdp.policy.step import STEP
from sdp.dataset.base_dataset import BaseImageDataset
from sdp.env_runner.base_image_runner import BaseImageRunner
from sdp.common.checkpoint_util import TopKCheckpointManager
from sdp.common.pytorch_util import dict_apply, optimizer_to
from sdp.model.diffusion.ema_model import EMAModel
from sdp.model.common.lr_scheduler import get_scheduler

OmegaConf.register_new_resolver("eval", eval, replace=True)

class TrainSTEPWorkspace:
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: STEP = hydra.utils.instantiate(cfg.policy)

        self.ema_model: STEP = None
...
def main(cfg):
    workspace = TrainSTEPWorkspace(cfg)
    workspace.run()
